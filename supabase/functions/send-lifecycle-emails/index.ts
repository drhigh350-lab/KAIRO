...
//
// Sends two kinds of Resend emails, both consent-gated at the SQL layer
// (kairo.get_streak_risk_candidates / kairo.get_new_achievement_candidates
// — see migration add_lifecycle_email_infrastructure) exactly like every
// other Kairo send path: silence is the default, delivery requires
// explicit consent (ConsentManager.canSend()'s own rule, restated here for
// this channel):
//
...
//
// kairo.email_log is the idempotency record for both — a send is only
