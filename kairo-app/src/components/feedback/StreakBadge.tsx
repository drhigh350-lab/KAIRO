...
export function StreakBadge({ days, dark = false }: StreakBadgeProps) {
  return (
    <span style={{
      display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', borderRadius: 'var(--radius-pill)',
      background: dark ? 'rgba(240,177,42,0.14)' : 'var(--accent-gold-bg)', color: 'var(--kairo-gold-500)', fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: 'var(--fs-body-sm)',
    }}>
