function PracticeSummary({ results, onHome, onAction }) {
  const { StatTile, ChevronRight } = window.KairoLearningUI;
  const { Card, Button, ScoreBadge } = window.KairoDesignSystem_1c2e7f;
...
window.KairoLearningUI = { ...window.KairoLearningUI, PracticeSummary };
