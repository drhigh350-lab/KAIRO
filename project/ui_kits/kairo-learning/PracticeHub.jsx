function PracticeHub({ subject, hasHistory, lockedType, onBack, onStart }) {
  ...
  const types = [
    { key: 'topic', label: 'Topic Practice', desc: 'Practice one topic deeply.' },
    { key: 'mixed', label: 'Mixed Practice', desc: `Questions from every ${subject.label} topic.` },
...
window.KairoLearningUI = { ...window.KairoLearningUI, PracticeHub };
