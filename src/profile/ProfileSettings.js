...
export class ProfileSettings {
  ...
  async deleteAllData() {
    ...
    // Every subsystem constructed with the old profile object directly
    ...
    // — see KairoEngine._attachFreshProfileSubsystems()'s own docstring.
    this.engine._attachFreshProfileSubsystems();
    return { deleted: true };
  }
}
